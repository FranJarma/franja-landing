...
export function Footer({ dictionary, locale }: FooterProps) {
  return (
    <footer className="section-frame pb-10">
      <div className="flex flex-col items-center gap-8 border-t border-white/10 pt-6 text-center text-sm text-white/50 md:flex-row md:items-end md:justify-between md:text-left">

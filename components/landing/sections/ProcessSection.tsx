import { processContent } from "@/constants/landing";
...
export function ProcessSection() {
  return (
    <Section id={processContent.id} labelledBy="process-title">
      <div className="overflow-hidden border border-white/10 bg-white/[0.02]">
        <div className="grid gap-12 p-8 md:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] md:p-12">
          <header className="space-y-6">
            ...
            <p className="body-muted max-w-xl">{processContent.description}</p>
